...
void fase_final(string jugadores_fase_exp[], int const CANT_JUGADORES, int estatuillas[], int const CANT_ESTATUILLAS, int intentos[][5], int& max_pdv, string& max_jugador);
...
void fase_expedicion(string jugadores_menu[], int const CANT_JUGADORES, int& max_pdv, string& max_jugador);
